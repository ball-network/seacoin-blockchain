...
root = here.parent
cache_path = root.joinpath(".sea_cache", "manage_clvm.json")
...
from sea.types.blockchain_format.serialized_program import SerializedProgram  # noqa: E402
...
top_levels = {"sea"}
hashes_path = root.joinpath("sea/wallet/puzzles/deployed_puzzle_hashes.json")
std_libraries = root.joinpath("sea/wallet/puzzles")
...
main(auto_envvar_prefix="SEA_MANAGE_CLVM")
