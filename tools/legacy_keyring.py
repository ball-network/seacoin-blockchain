"""
Provides a helper to access the legacy keyring which was supported up to version 1.6.1 of seacoin-blockchain. To use this
...
from sea.util.errors import KeychainUserNotFound
from sea.util.keychain import KeyData, KeyDataSecrets, get_private_key_user
