...
from sea.wallet.util.curry_and_treehash import curry_and_treehash
from sea.wallet.vc_wallet.vc_drivers import (
    COVENANT_LAYER_HASH,
...
CREDENTIAL_RESTRICTION: Program = load_clvm_maybe_recompile(
    ...
    package_or_requirement="sea.wallet.vc_wallet.cr_puzzles",
