...
from sea.wallet.notification_store import Notification, NotificationStore
from sea.wallet.transaction_record import TransactionRecord
from sea.wallet.util.compute_memos import compute_memos_for_spend
from sea.wallet.util.notifications import construct_notification
...
class NotificationManager:
    ...
    async def send_new_notification(
        ...
        full_tx: TransactionRecord = dataclasses.replace(
            sea_tx, spend_bundle=SpendBundle.aggregate([sea_tx.spend_bundle, extra_spend_bundle])
        )
        return full_tx
