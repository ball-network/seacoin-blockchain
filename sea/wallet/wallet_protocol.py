...
from sea.wallet.nft_wallet.nft_info import NFTCoinInfo
from sea.wallet.util.tx_config import CoinSelectionConfig
...
class WalletProtocol(Protocol[T]):
    ...
    async def coin_added(self, coin: Coin, height: uint32, peer: WSSeaConnection, coin_data: Optional[T]) -> None:
        ...
