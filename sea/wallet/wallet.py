...
from sea.wallet.puzzles.clawback.metadata import ClawbackMetadata
...
from sea.wallet.puzzles.puzzle_utils import (
...
from sea.wallet.util.wallet_types import WalletIdentifier, WalletType
...
class Wallet:
    ...
    async def create_tandem_xsea_tx(
        ...
        sea_coins = await self.select_coins(fee, tx_config.coin_selection_config)
        [sea_tx] = await self.generate_signed_transaction(
            uint64(0),
    ...
    # WSSeaConnection is only imported for type checking
