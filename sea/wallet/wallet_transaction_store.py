...
from sea.wallet.conditions import ConditionValidTimes
from sea.wallet.transaction_record import TransactionRecord, TransactionRecordOld, minimum_send_attempts
        ...
        async with self.db_wrapper.reader_no_transaction() as conn:
            rows = await conn.execute_fetchall(
                ...
                (
                 ...
                 if is_stake_farm else TransactionType.STAKE_LOCK_REWARD.value,
                ),
            )
