...
from sea.cmds.init_funcs import init
...
from sea.harvester.harvester_api import HarvesterAPI
from sea.introducer.introducer import Introducer
from sea.introducer.introducer_api import IntroducerAPI
from sea.protocols.shared_protocol import Capability, capabilities
from sea.seeder.crawler import Crawler
from sea.seeder.crawler_api import CrawlerAPI
from sea.seeder.dns_server import DNSServer, create_dns_server_service
from sea.seeder.start_crawler import create_full_node_crawler_service
from sea.server.outbound_message import NodeType
from sea.server.start_farmer import create_farmer_service
from sea.server.start_full_node import create_full_node_service
from sea.server.start_harvester import create_harvester_service
from sea.server.start_introducer import create_introducer_service
from sea.server.start_service import Service
from sea.server.start_timelord import create_timelord_service
from sea.server.start_wallet import create_wallet_service
from sea.simulator.block_tools import BlockTools, test_constants
from sea.simulator.full_node_simulator import FullNodeSimulator
from sea.simulator.keyring import TempKeyring
from sea.simulator.ssl_certs import get_next_nodes_certs_and_keys, get_next_private_ca_cert_and_key
from sea.simulator.start_simulator import create_full_node_simulator_service
from sea.ssl.create_ssl import create_all_ssl
from sea.timelord.timelord import Timelord
from sea.timelord.timelord_api import TimelordAPI
from sea.timelord.timelord_launcher import VDFClientProcessMgr, find_vdf_client, spawn_process
from sea.types.blockchain_format.sized_bytes import bytes32
from sea.types.peer_info import UnresolvedPeerInfo
from sea.util.bech32m import encode_puzzle_hash
from sea.util.config import config_path_for_filename, load_config, lock_and_load_config, save_config, set_peer_info
from sea.util.db_wrapper import generate_in_memory_db_uri
from sea.util.ints import uint16
from sea.util.keychain import bytes_to_mnemonic
from sea.util.lock import Lockfile
from sea.util.misc import SignalHandlers
from sea.wallet.wallet_node import WalletNode
from sea.wallet.wallet_node_api import WalletNodeAPI
...
async def setup_wallet_node(
    ...
    with TempKeyring(populate=True) as keychain:
        ...
        service_config["xsea_spam_amount"] = xsea_spam_amount
...
async def setup_farmer(
    ...
    service_config["xsea_target_address"] = encode_puzzle_hash(b_tools.farmer_ph, "xsea")
    service_config["pool_public_keys"] = [bytes(pk).hex() for pk in b_tools.pool_pubkeys]
    service_config["port"] = port
    service_config["rpc_port"] = uint16(0)
    config_pool["xsea_target_address"] = encode_puzzle_hash(b_tools.pool_ph, "xsea")
