...
from sea.rpc.rpc_server import default_get_connections
from sea.server.outbound_message import NodeType
from sea.simulator.block_tools import BlockTools
from sea.simulator.simulator_protocol import FarmNewBlockProtocol, GetAllCoinsProtocol, ReorgProtocol
...
from sea.util.config import lock_and_load_config, save_config
...
from sea.wallet.util.tx_config import DEFAULT_TX_CONFIG
...
class FullNodeSimulator(FullNodeAPI):
    ...
    async def farm_blocks_to_puzzlehash(
        ...
        is to receive XSEA at an address.
