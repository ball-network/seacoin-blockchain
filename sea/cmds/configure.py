...
from sea.util.config import load_defaults_for_missing_services, lock_and_load_config, save_config, str2bool
...
def configure(
    ...
    with lock_and_load_config(root_path, config_yaml, fill_missing_services=True) as config:
        ...
        if change_made:
            print("Restart any running sea services for changes to take effect")
