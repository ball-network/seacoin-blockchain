...
@click.option(
    ...
    "-d",
    help=(
        "Show the first wallet address using non-observer derivation. Older Sea versions use "
...
@click.option("--prefix", "-x", help="Address prefix (xsea for mainnet, txsea for testnet)", default=None, type=str)
@click.pass_context
def search_cmd(
    ctx: click.Context,
