...
from sea.cmds.cmds_util import NODE_TYPES
from sea.cmds.peer_funcs import peer_async
...
@click.option("-a", "--add-connection", help="Connect specified Sea service to ip:port", type=str, default="")
@click.option(
