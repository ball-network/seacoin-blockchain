...
help_text = """
\b
    The purpose of this command is find potential issues in Sea wallet databases.
    The core sea client currently uses sqlite to store the wallet databases, one database per key.
\b
