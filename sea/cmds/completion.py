...
def generate(shell: str) -> None:
    ...
    You can source it directly (performs slower) by running:
        \033[3;33meval "$(sea complete generate)"\033[0m
    or you can save the output to a file:
        \033[3;33msea complete generate > ~/.sea-complete-bash\033[0m
    and source that file with:
        \033[3;33m. ~/.sea-complete-bash\033[0m
    """
    ...
    subprocess.run(["sea"], check=True, env={**os.environ, "_SEA_COMPLETE": f"{shell}_source"})
