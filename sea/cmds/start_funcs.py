...
from sea.cmds.passphrase_funcs import get_current_passphrase
from sea.daemon.client import DaemonProxy, connect_to_daemon_and_validate
from sea.util.errors import KeychainMaxUnlockAttempts
from sea.util.keychain import Keychain
from sea.util.service_groups import services_for_groups
...
async def async_start(root_path: Path, config: Dict[str, Any], group: tuple[str, ...], restart: bool) -> None:
    ...
    if daemon is None:
        print("Failed to create the sea daemon")
        return None
