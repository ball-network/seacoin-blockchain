...
from sea.types.weight_proof import SubEpochChallengeSegment, SubEpochSegments
from sea.util.db_wrapper import DBWrapper2, execute_fetchone
from sea.util.errors import Err
from sea.util.full_block_utils import (
    GeneratorBlockInfo,
    PlotFilterInfo,
...
class BlockRecordDB(Streamable):
    ...
    def to_block_record(self, pos_ss_cc_challenge_hash: bytes32, cc_sp_hash: bytes32) -> BlockRecord:
        return BlockRecord(
            ...
            community_puzzle_hash=self.community_puzzle_hash,
    ...
    def from_block_record(cls, block_record: BlockRecord) -> BlockRecordDB:
        return cls(
            ...
            community_puzzle_hash=block_record.community_puzzle_hash,
            ...
            farmer_public_key=block_record.farmer_public_key,
        )
    ...
    async def create(cls, db_wrapper: DBWrapper2) -> BlockStore:
        ...
        async with self.db_wrapper.writer_maybe_transaction() as conn:
            ...
            if self.db_wrapper.db_version == 2:
                ...
                # in the sea/cmds/db_upgrade.py file
