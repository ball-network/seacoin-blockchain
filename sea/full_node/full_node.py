...
from sea.consensus.blockchain import AddBlockResult, Blockchain, StateChangeSummary
...
from sea.full_node.lock_queue import LockClient, LockQueue
...
from sea.full_node.sync_store import SyncStore
...
from sea.types.blockchain_format.vdf import CompressibleVDFField, VDFInfo, VDFProof
...
from sea.util.errors import ConsensusError, Err, ValidationError
...
class FullNode:
    ...
    async def _sync(self) -> None:
        ...
        try:
            ...
            peers_with_peak: List[WSSeaConnection] = [
    ...
    async def update_wallets(
        ...
        for peer, changes in changes_for_peer.items():
            if peer not in self.server.all_connections:
                continue
            ws_peer: WSSeaConnection = self.server.all_connections[peer]
