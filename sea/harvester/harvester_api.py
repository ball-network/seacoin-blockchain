...
from sea.plotting.util import PlotInfo, parse_plot_info
from sea.protocols import harvester_protocol
from sea.protocols.farmer_protocol import FarmingInfo
from sea.protocols.harvester_protocol import Plot, PlotSyncResponse
...
from sea.wallet.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def harvester_handshake(
        self, harvester_handshake: harvester_protocol.HarvesterHandshake, peer: WSSeaConnection
    ) -> None:
        """
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSSeaConnection
    ) -> None:
        """
