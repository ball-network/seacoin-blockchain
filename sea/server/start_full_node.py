...
from sea.rpc.full_node_rpc_api import FullNodeRpcApi
...
def main() -> int:
    ...
    with maybe_manage_task_instrumentation(enable=os.environ.get("SEA_INSTRUMENT_NODE") is not None):
        ...
        if not service_config.get("use_sea_loop_policy", True):
            target_peer_count = None
