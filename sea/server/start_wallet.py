...
from sea.rpc.wallet_rpc_api import WalletRpcApi
...
from sea.util.task_timing import maybe_manage_task_instrumentation
...
async def async_main() -> int:
    ...
    if local_test is True:
        from sea.simulator.block_tools import test_constants
...
def main() -> int:
    ...
    with maybe_manage_task_instrumentation(enable=os.environ.get("SEA_INSTRUMENT_WALLET") is not None):
