"""
NOTE: This contains duplicate code from `sea.cmds.plots`.
After `sea plots create` becomes obsolete, consider removing it from there.
"""
...
from sea.plotting.util import Params, add_plot_directory, validate_plot_size
...
def get_chiapos_install_info() -> Optional[Dict[str, Any]]:
    ...
    return {"display_name": "Sea Proof of Space", "version": chiapos_version, "installed": True}


def plot_sea(args: Namespace, root_path: Path) -> None:
    try:
