...
from sea.consensus.coinbase import (
    ...
    create_stake_lock_reward_coin,
)
from sea.consensus.constants import ConsensusConstants
from sea.consensus.cost_calculator import NPCResult
from sea.full_node.mempool_check_conditions import get_name_puzzle_conditions
...
from sea.types.blockchain_format.reward_chain_block import RewardChainBlock, RewardChainBlockUnfinished
...
from sea.types.stake_record import create_stake_farm_rewards, create_stake_lock_rewards
...
from sea.util.recursive_replace import recursive_replace
    ...
    if is_transaction_block:
        ...
        if height > 0:
            ...
            if curr.height > 0:
                ...
                if prev_transaction_block.height >= STAKE_FORK_HEIGHT and len(stake_lock_records) > 0:
