...
DEFAULT_CONSTANTS = ConsensusConstants(
    ...
    # Forks of sea should change this value to provide replay attack protection. This is set to mainnet genesis chall
    AGG_SIG_ME_ADDITIONAL_DATA=bytes.fromhex("b7bc81abc53a6fd1e9e50fc17e451adbc72f55e9c3d1edfafe58ade1c468c8c8"),
