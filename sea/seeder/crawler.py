...
class Crawler:
    ...
    async def connect_task(self, peer):
        async def peer_action(peer: WSSeaConnection):
    ...
    def set_server(self, server: SeaServer):
        self._server = server
    ...
    async def new_peak(self, request: full_node_protocol.NewPeak, peer: WSSeaConnection):
        try:
            peer_info = peer.get_peer_info()
    ...
    async def on_connect(self, connection: WSSeaConnection):
        pass
