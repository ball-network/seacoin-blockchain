...
from sea.protocols import full_node_protocol
from sea.protocols.full_node_protocol import RespondPeers
from sea.rpc.rpc_server import StateChangedProtocol, default_get_connections
from sea.seeder.crawl_store import CrawlStore
from sea.seeder.peer_record import PeerRecord, PeerReliability
...
class Crawler:
    ...
    async def create_client(
        self, peer_info: PeerInfo, on_connect: Callable[[WSSeaConnection], Awaitable[None]]
    ) -> bool:
    ...
    async def connect_task(self, peer: PeerRecord) -> None:
        ...
        async def peer_action(peer: WSSeaConnection) -> None:
