...
from sea.data_layer.data_layer_errors import OfferIntegrityError
...
from sea.data_layer.data_layer_wallet import DataLayerWallet, Mirror, verify_offer
from sea.rpc.data_layer_rpc_util import marshal
...
from sea.util.streamable import recurse_jsonify
from sea.util.ws_message import WsRpcMessage
...
class DataLayerRpcApi:
    ...
    def __init__(self, data_layer: DataLayer):  # , wallet: DataLayerWallet):
        ...
        self.service_name = "sea_data_layer"
