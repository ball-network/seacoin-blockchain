...
from sea.rpc.farmer_rpc_api import PlotInfoRequestData, PlotPathRequestData
from sea.rpc.rpc_client import RpcClient
from sea.types.blockchain_format.sized_bytes import bytes32
from sea.util.misc import dataclass_to_json_dict


class FarmerRpcClient(RpcClient):
    """
    Client to Sea RPC, connects to a local farmer. Uses HTTP/JSON, and converts back from
