...
from sea.data_layer.data_layer_wallet import Mirror, SingletonRecord
from sea.pools.pool_wallet_info import PoolWalletInfo
from sea.rpc.rpc_client import RpcClient
...
from sea.wallet.conditions import Condition, ConditionValidTimes, conditions_to_json_dicts
...
class WalletRpcClient(RpcClient):
    """
    Client to Sea RPC, connects to a local wallet. Uses HTTP/JSON, and converts back from
    JSON into native python objects before returning. All api calls use POST requests.
    Note that this is not the same as the peer protocol, or wallet protocol (which run Sea's
    ...
    async def nft_mint_bulk(
        ...
        xsea_coins: Optional[List[Dict]] = None,
        xsea_change_target: Optional[str] = None,
        ...
        request = {
            ...
            "xsea_change_target": xsea_change_target,
