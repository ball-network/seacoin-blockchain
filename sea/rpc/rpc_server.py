...
from sea.rpc.util import wrap_http_handler
from sea.server.outbound_message import NodeType
from sea.server.server import SeaServer, ssl_context_for_client, ssl_context_for_server
...
from sea.util.config import str2bool
from sea.util.ints import uint16
from sea.util.json_util import dict_to_json_str
from sea.util.network import WebServer, resolve
from sea.util.ws_message import WsRpcMessage, create_payload, create_payload_dict, format_response, pong
...
class RpcServiceProtocol(Protocol):
    ...
    def server(self) -> SeaServer:
        ...
        # a property so as to be read only which allows SeaServer to satisfy
        # Optional[SeaServer]
        ...
    ...
    def get_connections(self, request_node_type: Optional[NodeType]) -> List[Dict[str, Any]]:
        ...
        sea.rpc.rpc_server.default_get_connections()
        """
        ...
...
def default_get_connections(server: SeaServer, request_node_type: Optional[NodeType]) -> List[Dict[str, Any]]:
