...
from sea.clvm.singleton import SINGLETON_LAUNCHER
from sea.pools.pool_config import PoolWalletConfig, load_pool_config, update_pool_config
...
from sea.pools.pool_wallet_info import (
    FARMING_TO_POOL,
    LEAVING_POOL,
    SELF_POOLING,
    PoolSingletonState,
...
from sea.protocols.pool_protocol import POOL_PROTOCOL_VERSION
...
from sea.wallet.derive_keys import find_owner_sk
...
class PoolWallet:
    ...
    async def create_new_pool_wallet_transaction(
        ...
        the same pooling puzzle. This puzzle is a `sea singleton` that is
