...
class FarmerAPI:
        ...
        for sp in sps:
            ...
            if p2_singleton_puzzle_hash is not None:
                ...
                required_iters = calculate_iterations_quality(
                    ...
                    new_proof_of_space.sp_hash,
                    uint64(15 * 10**16),  # FIXME handle staking in pool protocol
                )
    ...
    @api_request(peer_required=True)
    async def new_signage_point(self, new_signage_point: farmer_protocol.NewSignagePoint, peer: WSSeaConnection) -> None:
        try:
