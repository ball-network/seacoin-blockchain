...
from sea.util.default_root import DEFAULT_KEYS_ROOT_PATH
from sea.util.file_keyring import FileKeyring
...
# the new passphrase.
DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE = "$ sea passphrase set # all the cool kids are doing it!"

MASTER_PASSPHRASE_SERVICE_NAME = "Sea Passphrase"
MASTER_PASSPHRASE_USER_NAME = "Sea Passphrase"
...
class KeyringWrapper:
    ...
    def _get_initial_cached_passphrase(self) -> str:
        ...
        """
        from sea.util.keychain import supports_os_passphrase_storage
