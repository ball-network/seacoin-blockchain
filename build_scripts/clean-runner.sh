...
rm -rf ../venv || true
rm -rf venv || true
rm -rf sea_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf seacoin-blockchain-gui/build || true
rm -rf seacoin-blockchain-gui/daemon || true
rm -rf seacoin-blockchain-gui/node_modules || true
rm seacoin-blockchain-gui/temp.json || true
( cd "$PWD/seacoin-blockchain-gui" && git checkout HEAD -- package-lock.json ) || true
cd "$PWD" || true
