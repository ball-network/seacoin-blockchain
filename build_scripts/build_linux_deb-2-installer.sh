...
pip install j2cli
CLI_DEB_BASE="seacoin-blockchain-cli_$SEA_INSTALLER_VERSION-1_$PLATFORM"
mkdir -p "dist/$CLI_DEB_BASE/opt/sea"
...
if [ "$PLATFORM" = "arm64" ]; then
  ...
  echo USE_SYSTEM_FPM=true electron-builder build --linux deb --arm64 \
    ...
    --config.deb.packageName="seacoin-blockchain"
...
GUI_DEB_NAME=seacoin-blockchain_${SEA_INSTALLER_VERSION}_${PLATFORM}.deb
mv "dist/${PRODUCT_NAME}-${SEA_INSTALLER_VERSION}.deb" "../../../build_scripts/dist/${GUI_DEB_NAME}"
