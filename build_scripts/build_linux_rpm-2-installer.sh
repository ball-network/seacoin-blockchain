...
echo electron-builder build --linux rpm "${OPT_ARCH}" \
  ...
  --config.rpm.packageName="seacoin-blockchain"
...
GUI_RPM_NAME="seacoin-blockchain-${SEA_INSTALLER_VERSION}-1.${REDHAT_PLATFORM}.rpm"
mv "dist/${PRODUCT_NAME}-${SEA_INSTALLER_VERSION}.rpm" "../../../build_scripts/dist/${GUI_RPM_NAME}"
