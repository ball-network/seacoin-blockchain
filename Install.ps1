...
{
    Write-Output "Sea requires a 64-bit Windows installation"
    Exit 1
}
...
Write-Output ""
Write-Output "SeaCoin blockchain .\Install.ps1 complete."
...
Write-Output ""
Write-Output "Type '.\venv\Scripts\Activate.ps1' and then 'sea init' to begin."
